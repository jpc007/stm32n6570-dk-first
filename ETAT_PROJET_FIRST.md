...
- **Documentation** : cette session est consignée ici ; sur `main` : `65f12d5` (principal, message *Red boot screen retained; NonSecure TZ HAL_Msp fix; LED chase timing; doc*), puis `4d1a138` (référence hash dans ce fichier). Dépôt : `stm32n6570-dk-first`.
