...
- **Documentation** : cette session est consignée ici ; branche `main` à jour jusqu’au commit **`083a101`** (dépôt `stm32n6570-dk-first`). Message principal du lot : *Red boot screen retained; NonSecure TZ HAL_Msp fix; LED chase timing; doc* (`65f12d5`).
